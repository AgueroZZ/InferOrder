...
result_RW1 <- EM_algorithm(
  ...
  modelName = "EEI",
  relative_lambda = T,
  rank_deficiency = (1 * ncol(sim$X)),
  iterate_once = T,
  tol = 1e-3,
  verbose = TRUE
)
plot(result_RW1$elbo_trace, col="blue", type="l", 
     cex = 0.1,
     xlab="Iteration", ylab="ELBO",
     main="ELBO Trace for RW1 Prior")
lines(result_RW1$loglik_trace, col="red", 
      cex = 0.1,
      type = "l", lty = "dashed")
```
...
```{r}
Q_prior_rw2 <- make_random_walk_precision(K = 20, d = 2, q=2, lambda=4, ridge = 0)
result_rw2 <- EM_algorithm(
  ...
  rank_deficiency = (2 * ncol(sim$X)),
  tol = 1e-3,
  verbose = TRUE
)
plot(result_rw2$elbo_trace, col="blue", type="l", 
     cex = 0.1,
     xlab="Iteration", ylab="ELBO",
     main="ELBO Trace for RW2 Prior")
lines(result_rw2$loglik_trace, col="red", 
      cex = 0.1,
      type = "l", lty = "dashed")
```
