...
set.seed(123)
q <- 1
result_RW1 <- optimize_initial_csmoothEM(X = Loadings, K = 100, rw_q = q, num_iter = 10, num_cores = 4) |>
...
set.seed(1234)
q <- 2
result_RW2 <- optimize_initial_csmoothEM(X = Loadings, K = 100, rw_q = q, num_iter = 10, num_cores = 4) |>
  do_csmoothEM(iter = 30)
