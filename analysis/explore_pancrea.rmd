...
```{r}
set.seed(1234567)
Q_prior_RW1 <- make_random_walk_precision(K=100, d=ncol(Loadings), lambda = 50, q=1, ridge = 1e-10)
...
```{r}
Q_prior_RW2 <- make_random_walk_precision(K=100, d=ncol(Loadings), lambda = 3000, q=2, ridge = 1e-10)
set.seed(12345)
# Random initialization
init_params <- make_default_init(Loadings, K=100)
# # Initialize based on the tSNE metric
# init_params <- make_init(X = Loadings, ordering_vec = tsne_metric, K = 100)
