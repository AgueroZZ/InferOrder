...
```{r}
set.seed(1234567)
Q_prior_RW1 <- make_random_walk_precision(K=100, d=ncol(Loadings), lambda = 100, q=1, ridge = 1e-10)
...
```{r}
Q_prior_RW2 <- make_random_walk_precision(K=100, d=ncol(Loadings), lambda = 150, q=2, ridge = 1e-10)
set.seed(12345)
# Random initialization
init_params <- make_default_init(Loadings, K=100)
