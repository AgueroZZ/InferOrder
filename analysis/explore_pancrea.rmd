...
```{r}
library(princurve)
pc_fit <- principal_curve(as.matrix(Loadings), maxit = 100, smoother = "smooth_spline", thresh = 1e-10)
...
set.seed(123)
q <- 1
Q_prior_RW1 <- make_random_walk_precision(K=100, d=ncol(Loadings), lambda = 50, q=q, ridge = 0)
# Initalize based on the tSNE metric
